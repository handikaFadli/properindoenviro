        ...
        <form
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <label for="edit_task_priority_code"
                    ...
                    <p id="edit-code-error"
                       class="hidden mt-1.5 text-xs text-red-500 items-center gap-1">
                        ...
                        <span id="edit-code-error-message"></span>
                ...
                <div>
                    ...
                    <label for="edit_task_priority_name"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                ...
                <div>
                    ...
                    <label for="edit_task_priority_color"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                ...
                <div>
                    ...
                    <label for="edit_task_priority_sort_order"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                    ...
                    <input
                        type="number"
                        name="sort_order"
                        id="edit_task_priority_sort_order"
                        min="0"
                ...
                <div>
                    ...
                    <label for="edit_task_priority_is_active"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                    ...
                    <select
                        name="is_active"
                        id="edit_task_priority_is_active"
