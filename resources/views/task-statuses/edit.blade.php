    ...
    <div id="edit-modal-content"
        ...
        <form id="edit-task-status-form"
            ...
            <div class="p-6 space-y-4">
                ...
                {{-- Code --}}
                <div>
                    <label for="edit_task_status_code"
                ...
                {{-- Name --}}
                <div>
                    <label for="edit_task_status_name"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                ...
                {{-- Color --}}
                <div>
                    <label for="edit_task_status_color"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                ...
                {{-- Sort Order --}}
                <div>
                    <label for="edit_task_status_sort_order"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
                    ...
                    <input
                        type="number"
                        name="sort_order"
                        id="edit_task_status_sort_order"
                        min="0"
                ...
                {{-- Status Aktif --}}
                <div>
                    <label for="edit_task_status_is_active"
                           class="block mb-1.5 text-sm font-medium
                                  text-gray-700 dark:text-gray-300">
